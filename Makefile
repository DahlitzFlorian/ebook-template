...
${BUILD}/pdf/${BOOKNAME}.pdf:
	mkdir -p ${BUILD}/pdf
	pandoc ${TOC} -f gfm --include-in-header pdf_properties.tex --include-in-header inline_code.tex --highlight tango --pdf-engine=xelatex -V documentclass=${LATEX_CLASS} -o $@ ${CHAPTERS}
